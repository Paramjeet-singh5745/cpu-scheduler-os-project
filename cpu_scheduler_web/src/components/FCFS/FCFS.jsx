...
import { fcfsScheduling } from "./FCFSAlgorithm";
...
export default function FCFS() {
  ...
  return (
    ...
    <div className="w-full min-h-screen bg-gray-100 p-6">
      ...
      <div className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-6 rounded-xl shadow mb-8">
        ...
        <p className="text-sm md:text-base">
          ...
          <b>First Come First Serve (FCFS)</b> is the simplest CPU scheduling
          algorithm. The process that arrives first in the ready queue is
          executed first. It follows the FIFO (First In First Out) principle.
