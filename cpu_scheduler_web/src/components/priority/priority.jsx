...
import { priorityScheduling } from "./priorityAlgorithm";
    ...
    <div className="w-full min-h-screen bg-gray-100 p-6">
      ...
      <div className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-6 rounded-xl shadow mb-8">
        ...
        <p className="text-sm md:text-base">
          ...
          <b>Priority Scheduling</b> is a CPU scheduling algorithm where each
          process is assigned a priority. The process with the highest priority
          (lowest number) is executed first.
              ...
              <tbody>
                ...
                {result.table.map((p, i) => (
                  ...
                  <tr key={i}>
                    ...
                    <td className="border p-3 text-center">{p.priority}</td>
